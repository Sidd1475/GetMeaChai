        ...
        <>
            ...
            <div className='text-white py-12 container mx-auto '>
                ...
                <div className='flex justify-center items-center text-white '>
                    ...
                    <div className="flex flex-col gap-2  min-h-screen min-w-[50vw]  p-10 text-center items-center">


                        <button
                            className="flex w-60  items-center text-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium  hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
